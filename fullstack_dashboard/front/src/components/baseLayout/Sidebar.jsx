            ...
            <ul className='menu-lists grid gap-y-1.5'>
              {
                MENU_LISTS.map((menu, index) => (
                  <li key={index} className='menu-item w-full'>
                    <Link to={routes[index].path} className='h-[44px] flex items-center gap-x-[14px] py-0.5 px-5 font-medium w-full bg-blue-700 dark:text-white text-gray-950 rounded-sm'>
                      <span className='w-5'>
