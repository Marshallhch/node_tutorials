...
const AppbarLang = () => {
  ...
  return (
    <div className='appbar-dropdown relative w-30 h-10 mx-7' ref={countryLangRef}>
      ...
      <div className={`dark:shadow-[0_0.125rem_0.25rem_rgba(255,255,255,0.3)] shadow-[0_0.125rem_0.25rem_rgba(165,163,174,0.3)] absolute top-full left-0 py-2 px-0 dark:bg-gray-950 bg-white rounded-sm text-gray-950 z-10 dark:text-white ${isDroplistEnabled ? "" : "hidden"}`}>
